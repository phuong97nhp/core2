...
import undraw_profile_1 from '../../../public/assets-admin/img/undraw_profile_1.svg';
import undraw_profile_2 from '../../../public/assets-admin/img/undraw_profile_2.svg';
import undraw_profile_3 from '../../../public/assets-admin/img/undraw_profile_3.svg';
import undraw_profile from '../../../public/assets-admin/img/undraw_profile.svg';
...
function Header() {
    ...
    const article = {};
    const HeadersAuth = {
        headers: {'Authorization': 'Bearer '+Cookies.get("auth_token_user")}
    }
    const handleLogout = () => {
        axios.post('http://127.0.0.1:8000/api/auth/logout', article, HeadersAuth)
        .then(res => {
            Cookies.remove('auth_token_user');
        })
        .catch(result => {
            return alert.info('Đăng xuất không thành công');
        });
    }
    ...
    return <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown no-arrow mx-1">
                <a className="nav-link dropdown-toggle" href="#" target="_blank">
            ...
            <li className="nav-item dropdown no-arrow">
                <Link className="nav-link dropdown-toggle" to="#" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span className="mr-2 d-none d-lg-inline text-gray-600 small">Nguyễn Hoàng Phương</span>
        ...
        <div className="modal fade" id="logoutModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-body">Bạn có thực sự muốn đăng xuất khỏi ứng dụng này.</div>
                    <div className="modal-footer">
                        <button className="btn btn-secondary" type="button" data-dismiss="modal">Trở về</button>
                        <a onClick={handleLogout} className="btn btn-primary" href="login">Thoát</a>
                    </div>
                </div>
            </div>
        </div>
